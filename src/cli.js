...
function getUserInfo() {
    ...
    console.log(messages.coffeePreference);
...
function displayWeather(data) {
    ...
    console.log(`The ${chalk.blueBright('temperature')} in ` + cityName + ' is currently ' +
...
function timeMessage(time) {
    ...
    console.log(`The time until the coffee changes ${chalk.blueBright('flavour')} is: ` +
